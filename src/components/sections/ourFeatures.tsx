  ...
  return (
    <section className="pb-20">
      <div className="container flex flex-col items-center gap-6">
        ...
        <p className="text-foreground/60 text-center">Blockchain transparency and profit sharing. Seamless <br /> integrations with 29+ platforms.</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-[95%] md:w-5/6 lg:w-4/5 mx-auto">
